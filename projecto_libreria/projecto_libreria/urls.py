...
urlpatterns = [
    ...
    #incluyo las urls de la aplicacion autores, todas las urls que pona en autores se montaran aqui
    path('libreria/',include("libreria.autores_urls"))]+static(settings.MEDIA_URL, document_root=settings.MEDIA_ROOT)